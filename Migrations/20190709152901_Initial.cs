    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdsVendor", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price_IsDealable = table.Column<bool>(nullable: false),
                    LogoUrl = table.Column<string>(nullable: true),
                    AdsFormId = table.Column<int>(nullable: false),
                    AdsVendorId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdsPost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdsPost_AdsForm_AdsFormId",
                        column: x => x.AdsFormId,
                        principalTable: "AdsForm",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdsPost_AdsVendor_AdsVendorId",
                        column: x => x.AdsVendorId,
                        principalTable: "AdsVendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdsPost_AdsFormId",
                table: "AdsPost",
                column: "AdsFormId");

            migrationBuilder.CreateIndex(
                name: "IX_AdsPost_AdsVendorId",
                table: "AdsPost",
                column: "AdsVendorId");
